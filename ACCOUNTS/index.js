...
function buildAccount() {
    inquirer
        ...
        .then((answer) => {
            ...
            console.log(
                chalk.green("Parabéns, a sua conta foi criada com sucesso!")
            );
...
function withdraw() {
    inquirer
        ...
        .then((answer) => {
            ...
            inquirer
                .prompt([
                    { name: "amount", message: "Quanto você deseja sacar?" },
                ])
                .then((answer) => {
...
function removeAmount(accountName, amount) {
    ...
    console.log(
        chalk.green(`Foi realizado um saque de R$${amount} da sau conta!`)
    );
    operation();
}
